            ...
            <div className="mx-auto max-w-7xl px-6 pb-32 pt-36 sm:pt-60 lg:px-8 lg:pt-32">
              <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
                <div className="relative w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
                  <p className="text-2xl my-4 text-gray-500">Kleek</p>
                  ...
                  <p className="mt-6 text-xl leading-8 text-gray-600 sm:max-w-md lg:max-w-none">
                    ...
                    Reduce no-shows, incentivize attendance, and create more
                    engaging events through smart deposits and rewards.
                  </p>
