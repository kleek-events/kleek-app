    ...
    <main>
      <div className="relative isolate">
        ...
        <div className="overflow-hidden">
          <div className="mx-auto max-w-7xl px-6 pb-32 pt-16 sm:pt-24 lg:px-8 lg:pt-20">
            <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
              <div className="relative w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
                <p className="my-4 text-2xl text-gray-500">Kleek</p>
                <h1 className="text-5xl font-bold tracking-tight text-gray-900 sm:text-7xl">
                  Turn no-shows into go-shows
                </h1>
                <p className="mt-6 text-xl leading-8 text-gray-600 sm:max-w-md lg:max-w-none">
                  Revolutionizing event management with blockchain technology. Reduce no-shows,
                  incentivize attendance, and create more engaging events through smart deposits and
                  rewards.
                </p>
